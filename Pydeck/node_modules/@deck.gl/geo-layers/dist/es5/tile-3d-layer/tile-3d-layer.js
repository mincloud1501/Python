...
var _getFrameState = require("./get-frame-state");
...
var Tile3DLayer = function (_CompositeLayer) {
  ...
  (0, _createClass2["default"])(Tile3DLayer, [{
    ...
    key: "updateState",
    value: function () {
      var _updateState = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(_ref2) {
    ...
    key: "_loadTileset",
    value: function () {
      var _loadTileset2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(tilesetUrl, fetchOptions, ionMetadata) {
        var _this = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                tileset3d = new _dTiles.Tileset3D(tilesetJson, tilesetUrl, _objectSpread({
                  onTileLoad: function onTileLoad(tileHeader) {
    ...
    value: function () {
      var _loadTilesetFromIon2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3(ionAccessToken, ionAssetId) {
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return (0, _dTiles._getIonTilesetMetadata)(ionAccessToken, ionAssetId);
    ...
    value: function _updateTileset(tileset3d) {
      ...
      var frameState = (0, _getFrameState.getFrameState)(viewport, Date.now());
