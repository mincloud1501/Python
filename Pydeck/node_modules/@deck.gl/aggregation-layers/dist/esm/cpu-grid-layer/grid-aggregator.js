...
var R_EARTH = 6378000;
export function pointToDensityGridDataCPU(_ref) {
  var data = _ref.data,
      cellSize = _ref.cellSize,
      getPosition = _ref.getPosition;

  var _pointsToGridHashing2 = _pointsToGridHashing(data, cellSize, getPosition),
      gridHash = _pointsToGridHashing2.gridHash,
      gridOffset = _pointsToGridHashing2.gridOffset;

  var result = _getGridLayerDataFromGridHash(gridHash, gridOffset);
