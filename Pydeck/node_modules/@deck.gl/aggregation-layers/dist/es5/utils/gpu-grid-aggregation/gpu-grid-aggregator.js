...
var GPUGridAggregator = function () {
  ...
  (0, _createClass2["default"])(GPUGridAggregator, [{
    ...
    value: function run() {
      ...
      if (useGPU) {
        _core2.log.warn('GPUGridAggregator: GPU Aggregation not supported, falling back to CPU')();
      }
    ...
    value: function initCPUResults(opts) {
      ...
      for (var id in weights) {
        ...
        aggregationData = (0, _resourceUtils.getFloatArray)(aggregationData, aggregationSize);

        if (combineMaxMin) {
          maxMinData = (0, _resourceUtils.getFloatArray)(maxMinData, _gpuGridAggregatorConstants.ELEMENTCOUNT);
          ...
          if (needMin) {
            minData = (0, _resourceUtils.getFloatArray)(minData, _gpuGridAggregatorConstants.ELEMENTCOUNT, Infinity);
            minData[_gpuGridAggregatorConstants.ELEMENTCOUNT - 1] = 0;
          }

          if (needMax) {
            maxData = (0, _resourceUtils.getFloatArray)(maxData, _gpuGridAggregatorConstants.ELEMENTCOUNT, -Infinity);
    ...
    value: function getAggregationModel() {
      ...
      return new _core.Model(gl, {
        ...
        modules: fp64 ? [_core2.project64] : ['project32'],
        vertexCount: 0,
        drawMode: 0
      });
    }
