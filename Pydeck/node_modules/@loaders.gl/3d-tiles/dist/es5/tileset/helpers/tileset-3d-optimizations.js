...
exports.checkChildrenWithinParent = checkChildrenWithinParent;
...
function checkChildrenWithinParent(tile) {
  assert(tile);
  ...
  if (boundingVolume instanceof TileOrientedBoundingBox || boundingVolume instanceof TileBoundingRegion) {
    ...
    tile._optimChildrenWithinParent = _constants.TILE3D_OPTIMIZATION_HINT.USE_OPTIMIZATION;

    for (var i = 0; i < length; (0, _readOnlyError2["default"])("i"), ++i) {
      ...
      if (!(childBoundingVolume instanceof TileOrientedBoundingBox || childBoundingVolume instanceof TileBoundingRegion)) {
        tile._optimChildrenWithinParent = _constants.TILE3D_OPTIMIZATION_HINT.SKIP_OPTIMIZATION;
        break;
      }
  ...
  return tile._optimChildrenWithinParent === _constants.TILE3D_OPTIMIZATION_HINT.USE_OPTIMIZATION;
}
