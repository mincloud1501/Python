...
exports.parse3DTileSync = parse3DTileSync;
...
function parse3DTileSync(arrayBuffer) {
  ...
  switch (tile.type) {
    case _constants.TILE3D_TYPE.COMPOSITE:
      return (0, _parse3dTileComposite.parseComposite3DTileSync)(tile, arrayBuffer, byteOffset, options, context, parse3DTileSync);

    case _constants.TILE3D_TYPE.BATCHED_3D_MODEL:
      return (0, _parse3dTileBatchedModel.parseBatchedModel3DTileSync)(tile, arrayBuffer, byteOffset, options, context);

    case _constants.TILE3D_TYPE.INSTANCED_3D_MODEL:
      return (0, _parse3dTileInstancedModel.parseInstancedModel3DTileSync)(tile, arrayBuffer, byteOffset, options, context);

    case _constants.TILE3D_TYPE.POINT_CLOUD:
      return (0, _parse3dTilePointCloud.parsePointCloud3DTileSync)(tile, arrayBuffer, byteOffset, options, context);
