...
var _marked = _regenerator["default"].mark(attributeIterator);

function attributeIterator(_ref) {
  var values, size, ArrayType, element, i, j;
  return _regenerator["default"].wrap(function attributeIterator$(_context) {
    while (1) {
